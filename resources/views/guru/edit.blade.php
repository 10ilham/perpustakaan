            ...
            <div class="card-body">
                <form action="{{ route('guru.profile.update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nama" id="nama" class="form-control" value="{{ $guru->user->nama }}" required>
                        @error('nama')
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" name="email" id="email" class="form-control" value="{{ $guru->user->email }}" required>
                        @error('email')
                        <div class="custom-alert" role="alert">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                                <path d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z"></path>
                    ...
                    <div class="form-group">
                        ...
                        <select name="mata_pelajaran" id="mata_pelajaran" class="form-control" required>
                            ...
                            <option value="Olahraga" {{ $guru->mata_pelajaran == 'Olahraga' ? 'selected' : '' }}>Olahraga</option>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="tanggal_lahir" id="tanggal_lahir" class="form-control" value="{{ $guru->tanggal_lahir }}" required>
                        @error('tanggal_lahir')
                        <div class="custom-alert" role="alert">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                                <path d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z"></path>
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" name="foto" id="foto" class="form-control" onchange="previewImage(event)" value="{{ $guru->foto }}">
                        ...
                        <div class="mt-3" id="preview-container" style="display: none;">
                            ...
                            <div class="preview-box" style="border: 2px solid #ddd; padding: 5px; display: inline-block; border-radius: 5px; margin-top: 5px;">
                                <img id="preview" src="{{ asset('assets/img/guru_foto/' . $guru->foto) }}" alt="Preview Foto" style="max-width: 120px; max-height: 120px; border-radius: 3px;">
                            </div>
                        </div>
                    ...
                    <div class="form-group text-end">
                        ...
                        <a href="{{ route('guru.profile') }}" class="btn btn-secondary">Batal</a>
                    </div>
                </form>
            </div>
        </div>
