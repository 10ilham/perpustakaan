                ...
                <form action="{{ route('anggota.update', $user->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="text-center mb-4">
                        <div class="avatar mb-3">
                            <img src="{{ $photoPath }}" alt="Foto Profil" style="max-width: 120px; border-radius: 50%;">
                        </div>
                        <h3>{{ $user->nama }}</h3>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="nip" id="nip" class="form-control" value="{{ old('nip', $profileData->nip ?? '') }}">
                        @error('nip')
                        <div class="custom-alert" role="alert">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                                <path d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z"></path>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="nis" id="nis" class="form-control" value="{{ old('nis', $profileData->nis ?? '') }}">
                        @error('nis')
                        <div class="custom-alert" role="alert">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                                <path d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z"></path>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="kelas" id="kelas" class="form-control" value="{{ old('kelas', $profileData->kelas ?? '') }}">
                        @error('kelas')
                        <div class="custom-alert" role="alert">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                                <path d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z"></path>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="mata_pelajaran" id="mata_pelajaran" class="form-control" value="{{ old('mata_pelajaran', $profileData->mata_pelajaran ?? '') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="bagian" id="bagian" class="form-control" value="{{ old('bagian', $profileData->bagian ?? '') }}">
                        @error('bagian')
                        <div class="custom-alert" role="alert">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                                <path d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z"></path>
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="tanggal_lahir" id="tanggal_lahir" class="form-control" value="{{ old('tanggal_lahir', $profileData->tanggal_lahir ?? '') }}">
                        @error('tanggal_lahir')
                        <div class="custom-alert" role="alert">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                                <path d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z"></path>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="no_telepon" id="no_telepon" class="form-control" value="{{ old('no_telepon', $profileData->no_telepon ?? '') }}">
                        @error('no_telepon')
                        <div class="custom-alert" role="alert">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                                <path d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z"></path>
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" name="foto" id="foto" class="form-control" onchange="previewImage(event)" value="{{ old('foto', $profileData->foto ?? '') }}">
                        ...
                        <div class="mt-3" id="preview-container" style="display: none;">
                            ...
                            <div class="preview-box" style="border: 2px solid #ddd; padding: 5px; display: inline-block; border-radius: 5px; margin-top: 5px;">
                                <img id="preview" src="{{ $photoPath }}" alt="Preview Foto" style="max-width: 120px; max-height: 120px; border-radius: 3px;">
                            </div>
                        </div>
                    ...
                    <div class="form-group text-end">
                        ...
                        <a href="{{ route('anggota.index', $user->id) }}" class="btn btn-secondary">Batal</a>
                    </div>
                </form>
            </div>
        </div>
