                    ...
                    <div class="card-body">
                        <form class="profile-display">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="nip" class="form-control" value="{{ $profileData->nip ?? '-' }}" readonly>
                            </div>
                            @elseif($user->level === 'siswa')
                            <div class="form-group">
                                <label for="nis">NIS</label>
                                <input type="text" id="nis" class="form-control" value="{{ $profileData->nis ?? '-' }}" readonly>
                            </div>
                            <div class="form-group">
                                <label for="kelas">Kelas</label>
                                <input type="text" id="kelas" class="form-control" value="{{ $profileData->kelas ?? '-' }}" readonly>
                            </div>
                            @elseif($user->level === 'guru')
                            <div class="form-group">
                                <label for="nip">NIP</label>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="mapel" class="form-control" value="{{ $profileData->mapel ?? '-' }}" readonly>
                            </div>
                            @elseif($user->level === 'staff')
                            <div class="form-group">
                                <label for="nip">NIP</label>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="bagian" class="form-control" value="{{ $profileData->bagian ?? '-' }}" readonly>
                            </div>
                            @endif
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" id="tanggal_lahir" class="form-control" value="{{ $profileData->tanggal_lahir ?? '-' }}" readonly>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="no_telepon" class="form-control" value="{{ $profileData->no_telepon ?? '-' }}" readonly>
                            </div>

                            <div class="form-group">
                                <label for="created_at">Terdaftar Pada</label>
                                <input type="text" id="created_at" class="form-control" value="{{ $user->created_at->format('d F Y H:i') }}" readonly>
                            </div>

                            <div class="form-group">
                                <label for="updated_at">Terakhir Diperbarui</label>
                                <input type="text" id="updated_at" class="form-control" value="{{ $user->updated_at->format('d F Y H:i') }}" readonly>
                            </div>
