                    ...
                    <div class="card-body">
                        <form class="profile-display">
                            <div class="form-group">
                                ...
                                <input type="text" id="name" class="form-control" value="{{ $siswa->user->nama }}" readonly>
                            </div>
                            <div class="form-group">
                                <label for="email">Email</label>
                                <input type="email" id="email" class="form-control" value="{{ $siswa->user->email }}" readonly>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" id="tanggal_lahir" class="form-control" value="{{ $siswa->tanggal_lahir }}" readonly>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="no_telepon" class="form-control" value="{{ $siswa->no_telepon }}" readonly>
                            </div>
                            <div class="form-group">
                                <div>
                                    <a href="{{ route('siswa.profile.edit') }}" class="btn btn-success">Edit Profil</a>
                                </div>
                            </div>
                        </form>
                    </div>
