...
class GuruController extends Controller
{
    ...
    public function updateProfile(Request $request)
    {
        ...
        $request->validate([
            ...
            'email' => 'required|email|max:50|unique:users,email,' . $guru->user->id,
            'nip' => 'required|numeric|digits_between:10,20|unique:guru,nip,' . $guru->id . '|unique:staff,nip|unique:admin,nip',
            'mata_pelajaran' => 'required|string|max:50',
            'tanggal_lahir' => 'required|date',
            'alamat' => 'required|string|max:255',
            'no_telepon' => 'required|numeric|digits_between:10,15|unique:guru,no_telepon,' . $guru->id . '|unique:siswa,no_telepon|unique:admin,no_telepon|unique:staff,no_telepon',
